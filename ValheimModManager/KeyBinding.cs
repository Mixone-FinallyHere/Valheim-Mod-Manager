    ...
    public class KeyBinding
    {
        ...
        internal object KeyControl
        {
            get
            {
                ...
                if (m_KeyControl == null)
                {
                    ...
                    {
                        ValheimModManager.Logger.Log($"Key {keyCode} was not found in new Input System.");
                    }
                }
                return m_KeyControl;
            }
        ...
        internal static void Initialize()
        {
            ...
            catch (Exception e)
            {
                ...
                ValheimModManager.Logger.Log($"Legacy Input is disabled.");
            }
            ...
            if (LegacyInputDisabled)
            {
                ...
                {
                    hasErrors = true;
                    ValheimModManager.Logger.LogException(e);
                    ValheimModManager.Logger.Error("Legacy Input was marked as disabled, but new Input System was not found.");
                }
            }
        }

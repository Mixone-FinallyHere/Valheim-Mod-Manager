    ...
    public partial class ValheimModManager
    {
        public partial class ModEntry
        {
            public class ModLogger
            {
                ...
                {
                    ValheimModManager.Logger.Log(str, Prefix);
                }

                public void Error(string str)
                {
                    ValheimModManager.Logger.Log(str, PrefixError);
                }

                public void Critical(string str)
                {
                    ValheimModManager.Logger.Log(str, PrefixCritical);
                }

                public void Warning(string str)
                {
                    ValheimModManager.Logger.Log(str, PrefixWarning);
                }

                public void NativeLog(string str)
                {
                    ValheimModManager.Logger.NativeLog(str, Prefix);
                }
                ...
                {
                    ValheimModManager.Logger.LogException(key, e, PrefixException);
                }
                ...
                {
                    ValheimModManager.Logger.LogException(null, e, PrefixException);
                }
            }
        }
        ...
        public static class Logger
        {
            ...
            public static readonly string filepath = Path.Combine(Path.Combine(Application.dataPath, Path.Combine("Managed", nameof(ValheimModManager))), "Log.txt");

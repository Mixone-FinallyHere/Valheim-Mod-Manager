...
namespace ValheimModManagerNet
{
    ...
    public static partial class Extensions
    {
        ...
        /// </summary>
        public static void Draw<T>(this T instance, ValheimModManager.ModEntry mod) where T : class, IDrawable, new()
        {
            ValheimModManager.UI.DrawFields(ref instance, mod, DrawFieldMask.OnlyDrawAttr, instance.OnChange);
        }

        /// <summary>
        /// Renders fields with mask OnlyDrawAttr. [0.22.15]
        /// </summary>
        public static void Draw<T>(this T instance, ValheimModManager.ModEntry mod, int unique) where T : class, IDrawable, new()
        {
            ValheimModManager.UI.DrawFields(ref instance, mod, unique, DrawFieldMask.OnlyDrawAttr, instance.OnChange);
        }
    }
}

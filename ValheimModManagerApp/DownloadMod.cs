...
namespace ValheimModManagerNet.Installer
{
    ...
    {
        public ValheimModManager.Repository.Release release;
        ...
        public DownloadMod(ValheimModManager.Repository.Release release)
        {
        ...
        private void Start()
        {
            try
            {
                var dir = Path.Combine(Path.GetTempPath(), "ValheimModManager");

...
namespace ValheimModManagerNet.Installer
{
    static class Log
    {
        ...
        public static void Print(string str, bool append = false)
        {
            if (append)
            {
                ValheimModManagerWindow.instance.statusLabel.Text += str;
                ValheimModManagerWindow.instance.statusLabel.ToolTipText += str;
            }
            else
            {
                ValheimModManagerWindow.instance.statusLabel.Text = str;
            ...
            stream?.Write(str);
            ValheimModManagerWindow.instance.inputLog.AppendText(str);
        }
